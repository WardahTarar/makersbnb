...
describe('availabity', function(){
  it('displays the listings that are available in that time', function(){
    listings = create.['one bed in holborn', 1/05/2019, 15/05/2019]
    listings = create.['two bed in waterloo', 1/05/2019, 20/05/2019]
    listings = create.['two bed in hampstead', 1/06/2019, 20/06/2019]
